...
export default function IconPin({ type, className }: IconProps): JSX.Element {
  return (
      ...
      {({ iconClassName }) => (
        ...
        >
          <g transform="rotate(22 200 200)">
            <path
              d="M379.577,247.395c-14.944-18.75-31.833-28.12-50.679-28.12V73.092c9.896,0,18.47-3.616,25.693-10.848
